...
@section('title', $category->nama . ' - CASLAB')
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <dl class="space-y-2">
                    <div class="flex justify-between">
                        ...
                        <dd class="text-gray-900">{{ $category->created_at->format('M d, Y g:i A') }}</dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-gray-600">Terakhir Diperbarui:</dt>
                        <dd class="text-gray-900">{{ $category->updated_at->format('M d, Y g:i A') }}</dd>
                    </div>
                </dl>
            </div>
        </div>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 id="delete-dialog-title" class="text-base font-semibold text-gray-900">Hapus Kategori</h3>
                            <div class="mt-2">
